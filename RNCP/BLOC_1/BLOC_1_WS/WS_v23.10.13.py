...
while True:
    try:
        start_page = int(input(Back.GREEN + "Please enter the first page : "))
        end_page = int(input(Back.GREEN + "Please enter the last page (not incl.) : " + Back.RESET))
...
# Create a "LOGS" folder in the current folder
...
# Create a "DB" folder in the current folder
